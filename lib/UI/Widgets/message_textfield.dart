...
import 'package:chats_ton/UI/Widgets/command_button.dart';
import 'package:chats_ton/UI/Widgets/conversation_widget.dart';
import 'package:chats_ton/UI/Widgets/qouted_message_widget.dart';
import 'package:chats_ton/UI/Widgets/share_content_shaeet.dart';
import 'package:chats_ton/UI/Widgets/tld_stri.dart';
...
import 'social_media_audio_recorder.dart';

class MessageTextField extends StatefulWidget {
  final String secondUserId;
  final String chatId;
  const MessageTextField(
      {super.key, required this.secondUserId, required this.chatId});
...
class _MessageTextFieldState extends State<MessageTextField>
  ...
  Duration recordingTime = const Duration();
  @override
  void initState() {
          ...
          : Row(
              children: [
                Visibility(
                  ...
                  child: InkWell(
                      onTap: () {
                        geet.Get.bottomSheet(BottomSheet(
                            onClosing: () {},
                            backgroundColor: Colors.white,
                            builder: (context) {
                              return ShareContentSheet(
                      ...
                      child: SvgPicture.asset('assets/Clip_icon.svg')),
                ),
                const SizedBox(
                  width: 10,
                ),
                Expanded(
                  child: Container(
                      ...
                      decoration: BoxDecoration(
                          ...
                          color: app.changeColor(color: 'F3F6F6')),
                      child: Row(
                        children: [
                          Expanded(
                            child: TextFormField(
                              ...
                              decoration: InputDecoration(
                                ...
                                hintStyle: GoogleFonts.poppins(
                                    ...
                                    color: app.changeColor(color: '6C6768')),
                ...
                Visibility(
                  ...
                  child: Row(
                    children: [
                      InkWell(
                          onTap: () {
                            ConversationProvider().sendImageMessage(
                                userModel.userId,
                                widget.secondUserId,
                                widget.chatId);
                            // ConversationProvider().pausePlayer();
                            // ConversationProvider().sendVideoMessage(userModel.userId,
                            //     widget.secondUserModel.userId, '', widget.chatId);
                          },
                      ...
                      InkWell(
                          ...
                          onLongPress: () {
                            ...
                            // });
                            Vibrate.feedback(FeedbackType.success);
                            _startOrStopRecording(userModel);

                            // ConversationProvider().sendVideoMessage(userModel.userId,
                            //     widget.secondUserModel.userId, '', widget.chatId);
                          },
                          child: SvgPicture.asset('assets/mic_icon.svg')),
                    ],
                  ),
                ),
                Visibility(
                    ...
                    child: Card(
                      ...
                      child: InkWell(
                        splashColor: app.changeColor(color: app.purpleColor),
                        borderRadius: BorderRadius.circular(200),
                        onTap: () {
                          sendMessage(userModel.userId);
                        },
                        child: Container(
                          decoration: BoxDecoration(
                            borderRadius: BorderRadius.circular(200),
    ...
    return Row(
      ...
      children: [
        SizedBox(
            ...
            child: Center(
                child: Text(
                    '${recordingTime.inMinutes}:${recordingTime.inSeconds}'))),
        InkWell(
          onTap: () async {
        ...
        //   recorderController: recorderController,
        //   waveStyle: WaveStyle(
        //     waveColor: app.changeColor(color: app.purpleColor),
        //     extendWaveform: true,
          ...
          child: Card(
            ...
            child: InkWell(
              ...
              child: Container(
                ...
                padding: const EdgeInsets.all(4),
                child: Transform.rotate(
                    angle: 5, child: SvgPicture.asset('assets/Send_icon.svg')),
              ),
            ),
          ),
        )
  ...
  String? path;
  void _startOrStopRecording(UserModel userModel) async {
    // try {
    //   if (isRecordingAudio) {
    //     recorderController.reset();
    ...
    //     if (path != null) {
    //       ConversationProvider().sendAudioMessage(
    //           userModel.userId, widget.secondUserId, path, widget.chatId);
    //       // isRecordingAudio = false;
    //       debugPrint(path);
  ...
  sendMessage(String userId) async {
    ConversationProvider().sendTextMessage(
        userId, widget.secondUserId, messageText.text.trim(), widget.chatId);
    messageText.clear();
...
class StreamMessageInputState extends State<StreamMessageInput>
  ...
  Widget _buildAttachmentButton(BuildContext context) {
    final defaultButtons = AttachmentButton(
